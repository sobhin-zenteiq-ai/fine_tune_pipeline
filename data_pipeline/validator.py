...
class TaskValidator(ABC):
    ...
    def get_optional_features(self) -> Set[str]:
        """Return optional features for the task"""
        pass
...
class QAValidator(TaskValidator):
    ...
    def get_optional_features(self) -> Set[str]:
        return {"context", "question", "answer", "system"}
...
class LMValidator(TaskValidator):
    ...
    def get_optional_features(self) -> Set[str]:
        return {"input", "target", "prompt", "completion", "content"}
...
class SummarizationValidator(TaskValidator):
    ...
    def get_optional_features(self) -> Set[str]:
        return {"text", "target", "input", "output", "article", "highlights"}
...
class ClassificationValidator(TaskValidator):
    ...
    def get_optional_features(self) -> Set[str]:
        return {"sentence", "class", "category", "target", "labels"}
...
class TranslationValidator(TaskValidator):
    ...
    def get_optional_features(self) -> Set[str]:
        return {"translation", "en", "fr", "de", "es", "input", "output", "src", "tgt"}
...
class SentimentValidator(TaskValidator):
    ...
    def get_optional_features(self) -> Set[str]:
        return {"label", "rating", "score", "polarity", "emotion"}
...
class NERValidator(TaskValidator):
    ...
    def get_optional_features(self) -> Set[str]:
        return {"text", "entities", "labels", "pos_tags", "chunk_tags"}
